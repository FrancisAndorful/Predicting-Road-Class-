...
road_data = gpd.read_file("./Desseldorf_Road.geojson")#.explode(index_parts=True)
point_data = gpd.read_file("./Desseldorf_amenity.geojson")

# Selecting the columns that are needed
columns_needed = ['@osmId', 'highway', 'geometry']
road_data = road_data[columns_needed]
...
# CALCULATING THE LENGTH OF THE ROAD AND ADDING TO THE DATA 
...
road_data_result.to_csv("GCN_Desseldorf_Data.csv")
