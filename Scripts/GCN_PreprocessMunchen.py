...
road_data = gpd.read_file("./Munchen_Road.geojson")#.explode(index_parts=True)
point_data = gpd.read_file("./Munchen_amenity.geojson")
...
road_data_result.to_csv("GCN_Munchen_Data.csv")
